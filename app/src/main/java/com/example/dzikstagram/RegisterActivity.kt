...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun saveUserInfo(
        ...
        userMap["image"] = "https://firebasestorage.googleapis.com/v0/b/sosial-media-b54e9.appspot.com/o/Default%20Image%2Fprofile.png?alt=media&token=de3eb7c0-7a5e-4fa6-bf76-a4b5d6bc2df1"

        userRef.child(currentUserID).setValue(userMap)
            .addOnCompleteListener { task ->
                if (task.isSuccessful){
                    progressDialog.dismiss()
                    Toast.makeText(this, "Account Sudah di Buat", Toast.LENGTH_SHORT).show()
