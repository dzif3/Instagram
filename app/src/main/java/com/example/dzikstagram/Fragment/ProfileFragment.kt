package com.example.dzikstagram.Fragment
...
import com.example.dzikstagram.AccountSettingActivity
import com.example.dzikstagram.R
import com.example.dzikstagram.model.User
...
class ProfileFragment : Fragment() {
        ...
        userRef.addValueEventListener(object : ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.exists()){
                    ...
                    view?.txt_full_nameProfile?.text = user?.getFullname()
    ...
    private fun getFollowing() {
        ...
        followingRef.addValueEventListener(object : ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.exists()){
                    view?.txt_totalFolowing?.text = p0.childrenCount.toString()
                }
            }
        })
    }
    ...
    private fun getFollowers() {
        ...
        followersRef.addValueEventListener(object : ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.exists()){
                    view?.txt_totalFolowers?.text = p0.childrenCount.toString()
                }
            }
        })
    }
